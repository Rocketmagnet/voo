...
////@begin Image_BrowserApp event table entries
////@end Image_BrowserApp event table entries
...
#endif
	ImageBrowser* mainWindow = new ImageBrowser( NULL, -1, _T("Image Browser"), wxDefaultPosition, wxSize(1024, 640));
